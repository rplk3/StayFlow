            ...
            <header className="bg-[#003B95] text-white">
                <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        <button className="bg-white text-[#003B95] px-4 py-2 font-medium rounded hover:bg-gray-100 transition">Register</button>
                        <button className="bg-white text-[#003B95] px-4 py-2 font-medium rounded hover:bg-gray-100 transition">Sign in</button>
                    </div>
                </div>
            </header>
