...
const MyAccount = () => {
    ...
    return (
        <div className="max-w-3xl">
            <h1 className="text-3xl font-extrabold text-[#003B95] mb-2">Personal Details</h1>
            <p className="text-gray-500 mb-8 max-w-xl">Update your information globally. This data is used to quickly fill checkout forms during booking.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                    ...
                    <p className="mt-2.5 text-xs text-gray-500 flex items-center">
                        ...
                        Your email address is your unique identity token and cannot be modified.
                    </p>
                </div>
